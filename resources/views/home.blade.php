                                    ...
                                    <div class="card bg-c-blue order-card">
                                        <div class="card-block">
                                            <h5>Categorias</h5>                                               
                                                ...
                                                @endphp
                                                <h2 class="text-right"><i class="fas fa-list f-left"></i><span>{{$cant_categorias}}</span></h2>
                                    ...
                                    <div class="card bg-c-green order-card">
                                        <div class="card-block">
                                                <h5>Productos</h5>                                               
                                                    ...
                                                    @endphp
                                                    <h2 class="text-right"><i class="fa fa-cubes f-left"></i><span>{{$cant_productos}}</span></h2>
